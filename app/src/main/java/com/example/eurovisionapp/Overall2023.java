...
public class Overall2023 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.overall_2023_layout);

        updateTop();

        ImageButton backButton = findViewById(R.id.auth_back);
        backButton.setOnClickListener(view -> {
            Intent intent = new Intent(Overall2023.this, MainActivity.class);
    ...
    public void updateTop() {
        ...
        for (int i = 0; i < countries2023.size(); i++) points.add(dictionary.get(countries2023.get(i)));
        ...
        while (!ord) {
            ...
            for (int i = 0; i < countries2023.size() - 1; i++)
