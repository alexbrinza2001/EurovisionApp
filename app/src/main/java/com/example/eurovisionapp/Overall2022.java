...
public class Overall2022 extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.overall_2022_layout);

        updateTop();

        ImageButton backButton = findViewById(R.id.auth_back);
        backButton.setOnClickListener(view -> {
            Intent intent = new Intent(Overall2022.this, MainActivity.class);
    ...
    public void updateTop() {
        ...
        for (String country : countries2022) {
        ...
        for (int i = 1; i <= userCounter; i++) {
            if (preferences.contains("1_2022_" + i) && !preferences.getString("1_2022_" + i, "").equals("12p"))  {
                ...
                String c2 = preferences.getString("2_2022_" + i, "");
                val = dictionary.get(c2);
                dictionary.put(c2, val + 10);
                String c3 = preferences.getString("3_2022_" + i, "");
                val = dictionary.get(c3);
                dictionary.put(c3, val + 8);
                String c4 = preferences.getString("4_2022_" + i, "");
                val = dictionary.get(c4);
                dictionary.put(c4, val + 7);
                String c5 = preferences.getString("5_2022_" + i, "");
                val = dictionary.get(c5);
                dictionary.put(c5, val + 6);
                String c6 = preferences.getString("6_2022_" + i, "");
                val = dictionary.get(c6);
                dictionary.put(c6, val + 5);
                String c7 = preferences.getString("7_2022_" + i, "");
                val = dictionary.get(c7);
                dictionary.put(c7, val + 4);
                String c8 = preferences.getString("8_2022_" + i, "");
                val = dictionary.get(c8);
                dictionary.put(c8, val + 3);
                String c9 = preferences.getString("9_2022_" + i, "");
                val = dictionary.get(c9);
                dictionary.put(c9, val + 2);
                String c10 = preferences.getString("10_2022_" + i, "");
        ...
        for (int i = 0; i < countries2022.size(); i++) points.add(dictionary.get(countries2022.get(i)));
